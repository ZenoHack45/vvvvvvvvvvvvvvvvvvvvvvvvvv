...
local Converted = {
	["King Von"] = Instance.new("ScreenGui");
...
Converted["_King Von"].DisplayOrder = 999
Converted["_King Von"].IgnoreGuiInset = true
Converted["_King Von"].ScreenInsets = Enum.ScreenInsets.DeviceSafeInsets
Converted["_King Von"].ZIndexBehavior = Enum.ZIndexBehavior.Sibling
Converted["_King Von"].Name = "King Von"
Converted["_King Von"].Parent = game:GetService("CoreGui")
...
Converted["_Frame"].Parent = Converted["_King Von"]
...
Converted["_TextLabel"].Text = "-- welcome to King Von"
...
Converted["_King Von"].Font = Enum.Font.SourceSans
Converted["_King Von"].Text = "King Von hint"
Converted["_King Von"].TextColor3 = Color3.fromRGB(255, 255, 255)
Converted["_King Von"].TextScaled = true
Converted["_King Von"].TextSize = 14
Converted["_King Von"].TextWrapped = true
Converted["_King Von"].AutoButtonColor = false
Converted["_King Von"].BackgroundColor3 = Color3.fromRGB(16.000000946223736, 16.000000946223736, 16.000000946223736)
Converted["_King Von"].BorderColor3 = Color3.fromRGB(0, 0, 0)
Converted["_King Von"].BorderSizePixel = 0
Converted["_King Von"].Position = UDim2.new(0.1251605, 0, 0.308291346, 0)
Converted["_King Von"].Size = UDim2.new(0, 113, 0, 42)
Converted["_King Von"].Name = "King Von"
Converted["_King Von"].Parent = Converted["_Presets"]

Converted["_UICorner12"].CornerRadius = UDim.new(0, 6)
Converted["_UICorner12"].Parent = Converted["_King Von"]
...
Converted["_UIStroke12"].Parent = Converted["_King Von"]
...
Converted["_Verify1"].Text = "King Von - Verification"
...
Converted["_str"].Parent = Converted["_King Von"]
...
local function DRHMECY_fake_script() -- Fake Script: StarterGui.King Von.Frame.Frame.LocalScript
...
local function KJUYZ_fake_script() -- Fake Script: StarterGui.King Von.Frame.c.LocalScript
    local script = Instance.new("LocalScript")
    script.Name = "LocalScript"
...
local function ZNBCSQ_fake_script() -- Fake Script: StarterGui.King Von.Frame.Framee.Clear.LocalScript
    local script = Instance.new("LocalScript")
    script.Name = "LocalScript"
...
local function AFONOR_fake_script() -- Fake Script: StarterGui.King Von.Frame.Framee.Execute.LocalScript
    local script = Instance.new("LocalScript")
    script.Name = "LocalScript"
...
local function YPCJUG_fake_script() -- Fake Script: StarterGui.King Von.Frame.Framee.scan.LocalScript
    local script = Instance.new("LocalScript")
    script.Name = "LocalScript"
...
local function WLFPRX_fake_script() -- Fake Script: StarterGui.King Von.Frame.Framee.rsix.LocalScript
    local script = Instance.new("LocalScript")
    script.Name = "LocalScript"
...
local function BEEKENZ_fake_script() -- Fake Script: StarterGui.King Von.Frame.Framee.dc.LocalScript
    local script = Instance.new("LocalScript")
    script.Name = "LocalScript"
...
local function CFRCL_fake_script() -- Fake Script: StarterGui.King Von.Frame.Framee.ScrollingFrame.Frame.TextBox.LocalScript
    local script = Instance.new("LocalScript")
    script.Name = "LocalScript"
...
local function ROEPF_fake_script() -- Fake Script: StarterGui.King Vont.Frame.Framee.ScrollingFrame.Frame.TextBox.LocalScript
    local script = Instance.new("LocalScript")
    script.Name = "LocalScript"
    script.Parent = Converted["_TextBox"]
    local req = require
...
local function AIXWS_fake_script() -- Fake Script: StarterGui.King Von.Frame.Framee.ScrollingFrame.Frame.LocalScript
    local script = Instance.new("LocalScript")
    script.Name = "LocalScript"
...
local function PYPIM_fake_script() -- Fake Script: StarterGui.King Von.Frame.Presets.Polaria.LocalScript
    local script = Instance.new("LocalScript")
    script.Name = "LocalScript"
...
local function BKZGV_fake_script() -- Fake Script: StarterGui.King Von.Frame.Presets.Shutdown.LocalScript
    local script = Instance.new("LocalScript")
    script.Name = "LocalScript"
...
local function LCBUNZQ_fake_script() -- Fake Script: StarterGui.King Von.Frame.Presets.Trash.LocalScript
    local script = Instance.new("LocalScript")
    script.Name = "LocalScript"
...
local function FBNBPO_fake_script() -- Fake Script: StarterGui.King Vont.Frame.Presets.Sledge.LocalScript
    local script = Instance.new("LocalScript")
    script.Name = "LocalScript"
...
local function RYFSR_fake_script() -- Fake Script: StarterGui.King Von.Frame.Presets.Star.LocalScript
    local script = Instance.new("LocalScript")
    script.Name = "LocalScript"
...
local function EQUPV_fake_script() -- Fake Script: StarterGui.King Von.Frame.Presets.CFour.LocalScript
    local script = Instance.new("LocalScript")
    script.Name = "LocalScript"
...
local function GKZXH_fake_script() -- Fake Script: StarterGui.King Von.Frame.Presets.Hub.LocalScript
    local script = Instance.new("LocalScript")
    script.Name = "LocalScript"
...
local function GZZULFM_fake_script() -- Fake Script: StarterGui.King Von.Frame.Presets.ExSer.LocalScript
    local script = Instance.new("LocalScript")
    script.Name = "LocalScript"
...
local function GGAOWS_fake_script() -- Fake Script: StarterGui.King Von.Frame.Presets.Grab.LocalScript
    local script = Instance.new("LocalScript")
    script.Name = "LocalScript"
...
local function JKNFHR_fake_script() -- Fake Script: StarterGui.King Von.Frame.Logs.LocalScript
    local script = Instance.new("LocalScript")
    script.Name = "LocalScript"
...
local function JZEZBK_fake_script() -- Fake Script: StarterGui.King Von.Frame.Logs.ToggleMode.LocalScript
    local script = Instance.new("LocalScript")
    script.Name = "LocalScript"
...
local function DVOMOYL_fake_script() -- Fake Script: StarterGui.King Von.Frame.Logs.BG.LocalScript
    local script = Instance.new("LocalScript")
    script.Name = "LocalScript"
...
local function DTBZ_fake_script() -- Fake Script: StarterGui.King Von.Frame.Sidebar.Executor.LocalScript
    local script = Instance.new("LocalScript")
    script.Name = "LocalScript"
...
local function ABLVN_fake_script() -- Fake Script: StarterGui.King Von.Frame.Sidebar.Presets.LocalScript
    local script = Instance.new("LocalScript")
    script.Name = "LocalScript"
...
local function ZWSBGHC_fake_script() -- Fake Script: StarterGui.King Von.Frame.Sidebar.Logs.LocalScript
    local script = Instance.new("LocalScript")
    script.Name = "LocalScript"
...
local function BJFA_fake_script() -- Fake Script: StarterGui.King Von.Frame.Verify.Btn.LocalScript
    local script = Instance.new("LocalScript")
    script.Name = "LocalScript"
...
local function YCEL_fake_script() -- Fake Script: StarterGui.King Von.Frame.m.LocalScript
    local script = Instance.new("LocalScript")
    script.Name = "LocalScript"
...
local function MMOF_fake_script() -- Fake Script: StarterGui.King Von.Frame.LocalScript
    local script = Instance.new("LocalScript")
    script.Name = "LocalScript"
...
local function OHZSZXY_fake_script() -- Fake Script: StarterGui.King Von.Frame.LocalScript
    local script = Instance.new("LocalScript")
    script.Name = "LocalScript"
    script.Parent = Converted["_Frame"]
    local req = require
	...
	local function fireRemoteEvent(code)
		if remoteEvent then
			print("â„¹ï¸ Executing code through backdoor:", remoteEvent:GetFullName())
			remoteEvent:FireServer(code)
		elseif remoteFunction then
			print("â„¹ï¸ Executing code through backdoor:", remoteFunction:GetFullName())
			pcall(function()
	...
	script.Parent.Presets.Star.MouseButton1Click:Connect(function()
		script.Parent.Framee.ScrollingFrame.Frame.TextBox.Text = 'local h=Instance.new("Hint") h.Parent=workspace h.Text="King Von Scanneer | the best forever!"'
		script.Parent.Framee.Visible = true
		script.Parent.Presets.Visible = false
		script.Parent.Logs.Visible = false
	end)
...
local function LZLXRPZ_fake_script() -- Fake Script: StarterGui.King Von.str.LocalScript
    local script = Instance.new("LocalScript")
    script.Name = "LocalScript"
...
local function QOXL_fake_script() -- Fake Script: StarterGui.King Von.str.LocalScript
    local script = Instance.new("LocalScript")
    script.Name = "LocalScript"
    script.Parent = Converted["_str"]
    local req = require
	...
	button.MouseButton1Up:Connect(function()
		button.BackgroundColor3 = Color3.fromRGB(18,16,16)
		button.UIStroke.Color = Color3.fromRGB(57,57,57)
	end)
end
